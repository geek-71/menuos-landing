...
export const metadata: Metadata = {
  ...
  description:
    'Turn your physical menu into a QR-code menu in minutes. Upload a photo, we extract the items, you publish for ₹199 — once. No subscriptions, no apps to download.',
  openGraph: {
