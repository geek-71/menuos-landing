# menumine Landing Page — Content Structure

## Design tokens
- Background: #FBF7F0 (warm paper cream)
- Surface: #FFFFFF
- Text: #1A1410 (near-black coffee)
- Primary accent: #C2410C (tandoor orange)
- Secondary accent: #166534 (curry leaf green)
- Muted: #8A7560
- Display font: Fraunces (serif, characterful)
- Body font: Inter
- Signature element: Functional QR code woven into the hero that scans to a live demo menu
...
## 3. Problem strip (the old way)
Three old-menu pain points, presented as crossed-out/struck content:
- Printing new menus every time a price changes
- Customers squinting at a laminated card under dim lighting
...
- **Toggle items in real time** — 86'd the fish? Flip a switch. It's off the menu instantly, on every table, no reprinting.
- **Variants without the spreadsheet** — Full, half, quarter. Plain, butter, garlic. Set it once per dish.
- **A banner that sells for you** — Feature your bestseller or run a weekend special, right at the top of the menu.
- **Five themes, zero design skills** — Classic, Modern, Bold, Earthy, Dark. Pick one that matches your dining room.
- **See what people actually think** — Star ratings and feedback land in your dashboard after every visit.
- **Built for one phone, one hand** — Every screen, yours and your customers', is designed mobile-first.

## 6. Customer-side preview (split screen)
Left: description of the customer experience
Right: visual — the actual themed menu UI
